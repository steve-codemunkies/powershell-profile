Function Start-HlJobScheduler {
    ...
    if($platform.ToLower() -eq "hh-us") {
        ...
        $path = "D:\git\cprm\src\core\Havas.CareForToday.JobScheduler.Host.OrthopaedicTherapy.UK\bin\Debug\Havas.CareForToday.JobScheduler.Host.OrthopaedicTherapy.UK.exe"
    }
